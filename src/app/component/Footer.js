    ...
    <footer className="site-footer">
      <div className="footer-container">
        ...
        <div className="footer-links">
          ...
          <a href="/get-involved/join-us">Join with Us</a>
        </div>
        {/* Contact */}
        <div className="footer-contact">
          <h3>Contact</h3>
          <p>Email: admin.thirunar.archives@gmail.com</p>
          <p>Phone: +91 98765 43210</p>
          <div className="footer-social">
            <a href="#">
              <i className="fab fa-facebook"></i>
            </a>
            <a href="https://www.instagram.com/thirunar_archives/">
        ...
        <div className="row w-100 text-center text-md-start align-items-center">
          ...
          {/* Right Text */}
           <div className="col-md-4 text-md-end">
            Designed by <strong>Vetrivel and Siddharth SvS (Jones Mattew)</strong>
          </div> 
        </div>
      </div>
      {/* Back to Top Button */}
